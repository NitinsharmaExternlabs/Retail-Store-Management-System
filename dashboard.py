...
class IMS:
    def __init__(self,root):
        ...
        lbl_menu=Label(LeftMenu,text="Menu",font=("times new roman",20),cursor="hand2",bg="#009688").pack(side=TOP,fill=X)
        ...
        #===footer=====
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Gautam,Nishant,Nitin,Prashant\nFor any technical issue contact: 821079xxxx",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
