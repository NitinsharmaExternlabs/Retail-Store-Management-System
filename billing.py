...
class BillClass:
    def __init__(self,root):
        ...
        root.iconbitmap("images\Flaticonmaker-Flat-Style-Shopping-bag.ico")
        self.root.title("Inventory Management System | Developed by Gautam, Nishant, Nitin, Prashant")
        ...
        self.cartTitle=Label(cart_Frame,text="Cart \t Total Products: [0]",font=("goudy old style",13),bg="lightgray")
        ...
        #===========Footer========
        footer=Label(self.root,text="IMS-Inventory Management System | Developed by Gautam, Nishant, Nitin, Prashant",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def search(self):
        ...
        try:
            if self.var_search.get()=="":
                messagebox.showerror("Error","Search input should be requirsd",parent=self.root)
            else:
