...
class Login_System:
    def __init__(self,root):
        ...
        # else:
        self.root.title("Login System | Developed by Gautam, Nishant, Nitin, Prashant ")
            ...
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    if chk=='f':
                        ...
                        lbl_cpass=Label(self.forget_win,text="Confirm Password",font=("times new roman",15)).place(x=20,y=225)
                        txt_cpass=Entry(self.forget_win,textvariable=self.var_conf_pass,font=("times new roman",15),bg="lightyellow").place(x=20,y=255,width=250,height=30)        
